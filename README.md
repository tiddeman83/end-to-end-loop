...
scripts/install.sh                # install SKILL.md, references, agents, and helper scripts
...
The script installs `SKILL.md`, `references/*.md`, `agents/openai.yaml`, and the helper scripts (`validate_skill.py`, `telemetry_record.py`, `telemetry_aggregate.py`, `test_telemetry_privacy.py`) under `~/.agents/skills/end-to-end-loop/`.
